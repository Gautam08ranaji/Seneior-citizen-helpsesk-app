...
const Handover = () => {
  ...
  const takeDamagedImage = (toolId: string) => {
    ...
    Alert.alert(
      t("handoverScreen.imageTaken"),
      t("handoverScreen.damagedToolImageAdded")
    );
  };
  ...
  const takeHandoverImage = () => {
    ...
    Alert.alert(
      t("handoverScreen.imageTaken"),
      t("handoverScreen.handoverImageAdded")
    );
  };

  const handleHandover = () => {
    if (!validateBeforeHandover()) return;
          ...
          {isEditing && (
            ...
            >
              ...
              <View style={styles.counterRow}>
                ...
                >
                  <Text
                    style={[styles.counterText, { color: theme.text.primary }]}
                  >
                    -
                  </Text>
                </TouchableOpacity>
                <Text style={[styles.qtyText, { color: theme.text.primary }]}>
                  {goodQty}
                </Text>
                <TouchableOpacity
                  style={[
              ...
              >
                <View style={styles.counterRow}>
                  <TouchableOpacity
                    ...
                    onPress={() =>
                      setDamagedQty((prev) => Math.max(0, prev - 1))
                    }
                  >
                    <Text
                      style={[
              ...
              {total !== item.qty && (
                <Text
                  style={[
                    styles.warning,
                    { color: theme.status?.error || "red" },
                  ]}
                >
                  {t("handoverScreen.warning", {
                    qty: item.qty,
                    name: item.name,
                  })}
                </Text>
  ...
  return (
    <View style={{ flex: 1, backgroundColor: theme.background.screen }}>
      <Header title={t("SettingsScreen.submitHandover")} />
      <View
        style={{
          flex: 1,
          backgroundColor: theme.background.section,
        ...
        >
          ...
          >
            ...
            {editingToolId ? (
              ...
              >
                <Text
                  style={[styles.handoverText, { color: theme.text.label }]}
                >
